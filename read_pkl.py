...
f3 = open('cpdict_sasa.pkl','rb')
sasa    = pickle.load(f1)
st_sasa = pickle.load(f2)
sasa3 = pickle.load(f3)

#plt.plot(sasa['PHE66'])
#plt.plot(st_sasa['PHE66'])
plt.hist(sasa['PHE105'], bins=[i for i in np.arange(0, 1.0, 0.02)], histtype='step', linewidth = 2)
plt.hist(sasa3['PHE66'], bins=[i for i in np.arange(0, 1.0, 0.02)], histtype='step', linewidth = 2)
